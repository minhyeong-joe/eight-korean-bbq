...
if (count($_POST)>0) {
  ...
  $MESSAGE_BODY = "<html><head><link href='https://fonts.googleapis.com/css?family=Lato|Montserrat' rel='stylesheet'></head><body style='text-align:center;'><br><br><br><h2 style='font-family: Lato, sans-serif;'>You have a new submission from <a href='https://eightkoreanbbq.com/contact'>Eight Korean BBQ</a></h2><hr style='width:700px; margin: 20px 0;'><br>";
  ...
  $MESSAGE_BODY .= "<img src='https://eightkoreanbbq/img/logo-8colorfnb.jpg' alt='8-logo' height='120px' style='margin-left: 200px;'><br></body></html>";
