...
if (count($_POST)>0) {
  ...
  $ToEmail = "keith@8colorsfnb.com, info@8colorsfnb.com";
  ...
  $MESSAGE_BODY = "<html><head></head><body><br><br><br><h2 style='text-align:center;'>You have a new franchise inquiry from <a href='https://eightkoreanbbq.com/franchise'>Eight Korean BBQ</a></h2><hr style='width:700px; margin: 20px auto;'><br>";
  ...
  $MESSAGE_BODY .= "<img src='https://eightkoreanbbq.com/img/logo-8colorfnb.jpg' alt='8colorsfnb-logo' height='120px' style='display: block; margin:auto;'><br></body></html>";
